...
from .GDANet_util import local_operator, GDM, SGCAM
...
class GDANET_cls(nn.Module):
    ...
    def forward(self, data_batch):
        ...
        #x = F.relu(self.bn6(self.linear1(x))) TODO: Find a better solution
        x = F.relu(self.linear1(x))
        x = self.dp1(x)
        #x = F.relu(self.bn7(self.linear2(x))) TODO: Find a better solution
