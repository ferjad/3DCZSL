...
class ShapeNetPart(Dataset):
    """ShapeNetCore part segmentation dataset_prep
...
class ShapeNetPartNormal(ShapeNetPart):
    """ShapeNetCore dataset_prep, points include normal."""
